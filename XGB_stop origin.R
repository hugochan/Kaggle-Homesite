...
# add new feature "null"
train$null <- apply(train, 1, function(z) sum(is.na(z)))
test$null <- apply(test, 1, function(z) sum(is.na(z)))
...
feature.names <- names(train)[c(3:302)] # +1
cat("Feature Names\n")
feature.names
...
write_csv(submission, "xgb_stop_date0131.csv")